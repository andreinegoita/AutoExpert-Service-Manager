    ...
    <PageTransition>
      <div className="min-h-screen bg-dark text-white p-4 md:p-8 font-sans">
        <div className="flex flex-col md:flex-row justify-between items-end md:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-gray-400 mt-1">
              Panoul de control al flotei tale.
            </p>
          </div>
          ...
          <div className="flex gap-3">
            <button
              ...
              className="bg-purple-600/20 hover:bg-purple-600 border border-purple-500/50 text-purple-300 hover:text-white px-4 py-2 rounded-xl flex items-center gap-2 transition font-medium"
            >
            ...
            <button
              ...
              className="bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-white px-3 py-2 rounded-xl border border-red-500/20 transition"
            >
              <LogOut size={18} />
            </button>
          </div>
        ...
        <motion.div
          ...
          className="bg-[#1e293b]/40 border border-white/10 rounded-3xl p-6 backdrop-blur-xl mb-8"
        >
          <h3 className="text-2xl font-bold mb-6 flex items-center gap-3">
            <Car className="text-gray-400" /> Flota Ta
          </h3>
...
const StatCard = ({ icon, title, value, delay = 0 }: any) => (
  <motion.div
    initial={{ opacity: 0, y: 20 }}
    animate={{ opacity: 1, y: 0 }}
    transition={{ delay }}
